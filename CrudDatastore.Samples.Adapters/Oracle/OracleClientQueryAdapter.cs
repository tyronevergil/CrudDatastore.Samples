...
{
    public class OracleClientQueryAdapter<T> : DelegateQueryAdapter<T> where T : EntityBase, new()
    {
        ...
        public OracleClientQueryAdapter(IOracleCommandFactory factory, string tableName)
            : base
            (
                /* read */
                (predicate) =>
