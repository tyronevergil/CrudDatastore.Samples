...
namespace CrudDatastore.Samples.EntityFramework.Specifications
{
    public class PersonSpecs : Specification<Entities.Person>
    {
        ...
        public static PersonSpecs Get(string firstname)
        {
            return new PersonSpecs(p => p.Firstname == firstname);
        }
